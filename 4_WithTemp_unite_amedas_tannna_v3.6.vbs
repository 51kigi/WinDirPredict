...
'対象ファイルのパスを設定
strFilePath_integrated= ".\data\3_WithTemp_integrated_amedas_v2_1.csv"
strFilePath_tanna=".\data\raw\1_tanna\tannna_original_v2_"
strFilePath_tmp_tanna=".\data\tmp_tanna.csv"
strOutputFilePath=".\data\4_WithTemp_united_amedas_tanna_test3.5.csv"
...
'Header文字格納
outstr="mishima_id,aziro_id,date,time,mishima_dir,mishima_speed,mishima_temp,aziro_dir,aziro_speed,ajiro_temp,tanna_date,tanna_time,tannna_dir,tanna_speed,tanna_date+3,tanna_time+3,tannna_dir+3,tanna_speed+3,judge"
